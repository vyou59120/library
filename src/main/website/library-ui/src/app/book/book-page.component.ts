...
export class BookPageComponent implements OnInit {
    ...
    private types = [ 'Isbn', 'Title'];
    private isbn: string;
    private title: string;
    private displayType: string = 'Isbn'
    private headsTab = ['ISBN', 'TITLE', 'AUTHOR', 'RELEASE DATE', 'REGISTER DATE', 'TOTAL EXAMPLARIES', 'CATEGORY'];
    private isNoResult: boolean = true;
    private isFormSubmitted: boolean = false;
    private actionButton: string = 'Save';
    private titleSaveOrUpdate: string = 'Add New Book Form';
    private messageModal: string;
    private displayMessageModal: boolean = false;
    
    private categories: Category[] = [{code:"", label:""}];
    private book = new Book();
    private searchBooksResult: Book[] = [];
